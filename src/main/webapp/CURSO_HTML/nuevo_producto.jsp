			...
			<section>
				...
				<form action="agg_producto.jsp" method="post" id="formulario">
					<table border=1>
						...
						<tr>
							<td>Categoria:</td>
							<td><input type="text" name="txtCat" maxlength="25" /></td>
						</tr>
						<tr>
							<td>Nombre del Producto:</td>
							<td><input type="text" name="txtNproducto" maxlength="25" /></td>
						</tr>
						<tr>
							<td>Precio:</td>
							<td><input type="text" name="txtPrecio" maxlength="25" /></td>
						</tr>
						<tr>
							<td>Cantidad:</td>
							<td><input type="number" name="numCant" maxlength="25" /></td>
						</tr>
						<tr>
